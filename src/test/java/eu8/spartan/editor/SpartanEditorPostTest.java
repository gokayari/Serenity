...
public class SpartanEditorPostTest extends SpartanNewBase {
    ...
    public void postSpartanAsEditor(){
        ...
        //when you need deserialize  or serialize, you don't need to add separate dependency,
        ...
        Ensure.that("Success message is correct",
                thenPart -> thenPart.body("success",is("A Spartan is Born!"))); //also>> is(equalTo("A Spartan is Born!"))
        ...
        //check location header ends with newly generated id >>> ex: http://18.205.113.195:7000/api/spartans/144
        //how can I get id and save:
